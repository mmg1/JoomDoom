...
def ze_args():
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python joomdoom.py --url http://site/administrator --username user --wordlist passwords.txt")
    parser.add_argument(
    ...
    parser.add_argument(
        '--ua', type=str, help='User-Agent', required=False, default="Mozilla/5.0 (X11; Linux x86_64; rv:64.0) Gecko/20100101 Firefox/64.0")
